...
const handleLogin = (event) => {
  ...
  if (email && password) {
    // Call the login API
    fetch("https://foodooni-food-shop-backend.onrender.com/api/user/login/", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
...
// profile showing
const API_PROFILE_URL = "https://foodooni-food-shop-backend.onrender.com/api/user/profile/";
const API_CHANGE_PASSWORD_URL =
  "https://foodooni-food-shop-backend.onrender.com/api/user/changepassword/";
const API_RESET_PASSWORD_URL =
  "https://foodooni-food-shop-backend.onrender.com/api/user/send-reset-password-email/";
