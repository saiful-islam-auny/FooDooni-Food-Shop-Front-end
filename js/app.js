document.addEventListener("DOMContentLoaded", () => {
  // const API_BASE_URL = "https://foodooni-food-shop-backend-ogvo.onrender.com/api/menu";
  const API_BASE_URL = "https://foodooni-food-shop-backend-ogvo.onrender.com/api/menu";
      ...
      discountItems.forEach((item) => {
        const imageUrl = item.image
          ? item.image.startsWith("http")
            ? item.image
            : `https://foodooni-food-shop-backend-ogvo.onrender.com${item.image}`
...
document.addEventListener("DOMContentLoaded", () => {
  const API_CART_URL = "https://foodooni-food-shop-backend-ogvo.onrender.com/api/cart/";
        ...
        data.items.forEach((item) => {
          const imageUrl = item.food_item.image
            ? item.food_item.image.startsWith("http")
              ...
              : `https://foodooni-food-shop-backend-ogvo.onrender.com${item.food_item.image}`
...
document.addEventListener("DOMContentLoaded", () => {
  const API_ORDER_HISTORY_URL = "https://foodooni-food-shop-backend-ogvo.onrender.com/api/order/history/";
  ...
  function renderOrderHistory(orders) {
    ...
    const BASE_URL = "https://foodooni-food-shop-backend-ogvo.onrender.com"; // Base URL for the images
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  orderForm.addEventListener("submit", async (e) => {
    ...
    try {
      ...
      const response = await fetch("https://foodooni-food-shop-backend-ogvo.onrender.com/api/order/", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
